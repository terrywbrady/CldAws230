...
@[106-119](Create Tags 1)
@[120-128](Create Tags 2)
@[131-142](Inject UserData 1)
@[143-152](Inject UserData 2)
@[153-162](Inject UserData 3)
@[163-175](Inject UserData 4)
...
@[345-355](CLI testing interface 1)
@[355-364](CLI testing interface 2)
@[365-374](CLI testing interface 3)
